...
the Keyfactor Command Portal
   ...
   ![CloudflareEdge Basic Tab](docsource/images/CloudflareEdge-basic-store-type-dialog.png)
   ...
   ![CloudflareEdge Advanced Tab](docsource/images/CloudflareEdge-advanced-store-type-dialog.png)
